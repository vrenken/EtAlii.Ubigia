...
namespace EtAlii.Ubigia.Infrastructure.Functional.Tests
{
    ...
    [CorrelateUnitTests]
    public sealed class ContentDefinitionRepositoryTests : IClassFixture<FunctionalInfrastructureUnitTestContext>
    {
        ...
        public ContentDefinitionRepositoryTests(FunctionalInfrastructureUnitTestContext testContext)
        {
        ...
        public async Task ContentDefinitionRepository_Store_Null()
        {
            ...
            {
                await _testContext.Infrastructure.ContentDefinition.Store(entry.Id, (ContentDefinition) null).ConfigureAwait(false);
            });
        ...
        public async Task ContentDefinitionRepository_Store_No_Identifier()
        {
            ...
            var act = new Func<Task>(async () =>
            {
                await _testContext.Infrastructure.ContentDefinition.Store(Identifier.Empty, contentDefinition).ConfigureAwait(false);
            });
        ...
        public async Task ContentDefinitionRepository_Get_ContentDefinition()
        {
            ...
            // Arrange.
            var retrievedContentDefinition = await _testContext.Infrastructure.ContentDefinition.Get(entry.Id).ConfigureAwait(false);
        ...
        public async Task ContentDefinitionRepository_Store_ContentDefinitionPart()
        {
            ...
            // Act.
            await _testContext.Infrastructure.ContentDefinition.Store(entry.Id, contentDefinitionPart).ConfigureAwait(false);
        ...
        public async Task ContentDefinitionRepository_Store_ContentDefinitionPart_Outside_Bounds()
        {
            ...
            // Act.
            var act = new Func<Task>(async () => await _testContext.Infrastructure.ContentDefinition.Store(entry.Id, contentDefinitionPart).ConfigureAwait(false));
        ...
        public async Task ContentDefinitionRepository_Store_ContentDefinitionPart_Twice()
        {
            ...
            await _testContext.Infrastructure.ContentDefinition.Store(entry.Id, contentDefinition).ConfigureAwait(false);
            await _testContext.Infrastructure.ContentDefinition.Store(entry.Id, contentDefinitionPartFirst).ConfigureAwait(false);

            // Act.
            var act = new Func<Task>(async () => await _testContext.Infrastructure.ContentDefinition.Store(entry.Id, contentDefinitionPartSecond).ConfigureAwait(false));
