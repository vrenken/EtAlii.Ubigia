...
namespace EtAlii.Ubigia.Infrastructure.Functional
{
    ...
    public class InfrastructureOptions : ConfigurationBase, IInfrastructureOptions, IEditableInfrastructureOptions
    {
        ...
        /// <inheritdoc />
        IConfiguration IEditableInfrastructureOptions.ConfigurationRoot { get => ConfigurationRoot; set => ConfigurationRoot = value; }
        ...
        public InfrastructureOptions(ISystemConnectionCreationProxy systemConnectionCreationProxy)
        {
