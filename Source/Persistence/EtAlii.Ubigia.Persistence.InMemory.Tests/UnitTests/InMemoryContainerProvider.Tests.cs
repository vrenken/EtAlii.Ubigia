...
namespace EtAlii.Ubigia.Persistence.InMemory.Tests
{
    ...
    public class InMemoryContainerProviderTests
    {
        ...
        [Fact, Trait("Category", TestAssembly.Category)]
        public void InMemoryContainerProvider_FromIdentifier_Without_EraPeriodMoment()
        {
            // Arrange.
        ...
        [Fact, Trait("Category", TestAssembly.Category)]
        public void InMemoryContainerProvider_FromIdentifier_With_EraPeriodMoment()
        {
            // Arrange.
            var id = _testIdentifierFactory.Create();
        ...
        [Fact, Trait("Category", TestAssembly.Category)]
        public void InMemoryContainerProvider_FromIdentifier_With_EraPeriodMoment_AsStrings()
        {
            // Arrange.
            var id = _testIdentifierFactory.Create();
        ...
        [Fact, Trait("Category", TestAssembly.Category)]
        public void InMemoryContainerProvider_FromIdentifier_With_EraPeriodMoment_AsStrings_Partially()
        {
            // Arrange.
            var id = _testIdentifierFactory.Create();
