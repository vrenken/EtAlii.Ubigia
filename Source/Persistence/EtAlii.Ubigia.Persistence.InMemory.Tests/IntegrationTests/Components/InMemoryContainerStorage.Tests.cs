...
namespace EtAlii.Ubigia.Persistence.InMemory.Tests
{
    ...
    public class InMemoryComponentStorageTests : IDisposable
    {
        private readonly InMemoryStorageUnitTestContext _testContext;
        public InMemoryComponentStorageTests()
        {
        ...
        [Fact]
        public void InMemoryComponentStorage_Prepare_Container()
        {
            // Arrange.
        ...
        [Fact]
        public void InMemoryComponentStorage_GetNextContainer_StorageException()
        {
            // Arrange.
        ...
        [Fact]
        public void InMemoryComponentStorage_Store_StorageException()
        {
            // Arrange.
        ...
        [Fact]
        public void InMemoryComponentStorage_StoreAll_StorageException()
        {
            // Arrange.
        ...
        [Fact]
        public void InMemoryComponentStorage_Store_Entry()
        {
            // Arrange.
        ...
        */
        ...
        [Fact]
        public void InMemoryComponentStorage_Store_PreviousComponent_Twice()
        {
            // Arrange.
            var storageId = Guid.NewGuid();
            var accountId = Guid.NewGuid();
        ...
        [Fact]
        public void InMemoryComponentStorage_Store_NextComponent_Twice()
        {
            // Arrange.
            var storageId = Guid.NewGuid();
            var accountId = Guid.NewGuid();
        ...
        [Fact]
        public void InMemoryComponentStorage_Store_DowndateComponent_Twice()
        {
            // Arrange.
            var storageId = Guid.NewGuid();
            var accountId = Guid.NewGuid();
            ...
            var act = new Action(() =>
            {
                _testContext.Storage.Components.Store(containerId, secondDowndate);
            });
        ...
        //[Fact]
        //public void InMemoryComponentStorage_Store_UpdateComponent_Twice()
        //{
        ...
        [Fact]
        public void InMemoryComponentStorage_Store_ParentComponent_Twice()
        {
            // Arrange.
            var storageId = Guid.NewGuid();
            var accountId = Guid.NewGuid();
            ...
            var act = new Action(() =>
            {
                _testContext.Storage.Components.Store(containerId, secondParent);
            });
