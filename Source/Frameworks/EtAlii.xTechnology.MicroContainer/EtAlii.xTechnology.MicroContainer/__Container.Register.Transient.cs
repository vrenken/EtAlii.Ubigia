...
//	        {
//		        throw new InvalidOperationException("Service Type already registered as singleton: " + serviceType);
//	        }
//	        var factoryType = typeof(IFactory<TService>);
//	        if (HasRegistration(factoryType))
//	        {
//		        throw new InvalidOperationException("Service Factory Type already registered: " + factoryType);
//	        }
...
//            }
//            mapping.ConcreteType = typeof(IFactory<TImplementation>);
//        }

//        public void RegisterTransient<TService, TImplementation>(Func<TImplementation> constructMethod)
//            where TImplementation : TService
//        {
//            var serviceType = typeof(TService);
//            if (HasRegistration(serviceType))
