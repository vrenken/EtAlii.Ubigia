...
namespace EtAlii.Ubigia.Api.Functional.Querying.EntityFrameworkCore.Storage.Internal
{
    ...
    public interface IUbigiaStore
    {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        IReadOnlyList<UbigiaTableSnapshot> GetTables([NotNull] IEntityType entityType);
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        UbigiaIntegerValueGenerator<TProperty> GetIntegerValueGenerator<TProperty>([NotNull] IProperty property);
