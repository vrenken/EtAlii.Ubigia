...
namespace EtAlii.Ubigia.Api.Functional.Querying.EntityFrameworkCore.Internal
{
    ...
    /// </summary>
    public static class UbigiaLoggerExtensions
    {
        /// <summary>
        ///     This is an internal API that supports the Entity Framework Core infrastructure and not subject to
        ///     the same compatibility standards as public APIs. It may be changed or removed without notice in
        ...
        {
            var definition = UbigiaResources.LogTransactionsNotSupported(diagnostics);
        ...
        public static void ChangesSaved(
            ...
            int rowsAffected)
        {
            var definition = UbigiaResources.LogSavedChanges(diagnostics);
