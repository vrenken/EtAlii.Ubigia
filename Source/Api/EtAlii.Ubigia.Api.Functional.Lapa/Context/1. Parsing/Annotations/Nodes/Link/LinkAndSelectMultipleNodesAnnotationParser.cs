...
namespace EtAlii.Ubigia.Api.Functional.Context
{
    ...
    internal sealed class LinkAndSelectMultipleNodesAnnotationParser : ILinkAndSelectMultipleNodesAnnotationParser
    {
        public string Id => nameof(LinkAndSelectMultipleNodesAnnotation);
        ...
        public LinkAndSelectMultipleNodesAnnotationParser(
        ...
        public NodeAnnotation Parse(LpNode node)
        {
            ...
            return new LinkAndSelectMultipleNodesAnnotation(sourcePath, targetPath, targetLinkPath);
        }
