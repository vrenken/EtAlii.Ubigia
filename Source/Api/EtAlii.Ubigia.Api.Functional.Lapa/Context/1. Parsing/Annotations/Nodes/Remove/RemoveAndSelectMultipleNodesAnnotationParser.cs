...
internal sealed class RemoveAndSelectMultipleNodesAnnotationParser : IRemoveAndSelectMultipleNodesAnnotationParser
{
    public string Id => nameof(RemoveAndSelectMultipleNodesAnnotation);
