...
namespace EtAlii.Ubigia.Api.Functional.Parsing.Tests
{
    ...
    public partial class ScriptParserTests
    {
        ...
        public void ScriptParser_Root_Add_Time_MMDDHHMMSS_FormattedString_DoubleQuotes_Absolute()
        {
            // Arrange.
        ...
        [Fact, Trait("Category", TestAssembly.Category)]
        public void ScriptParser_Root_Add_Time_MMDDHHMMSS_FormattedString_DoubleQuotes_Relative()
        {
            // Arrange.
            const string query = "time:\"2016\" += 12/04/13/38/22";
        ...
        [Fact, Trait("Category", TestAssembly.Category)]
        public void ScriptParser_Root_Add_Time_DDHHMMSS_FormattedString_DoubleQuotes_Absolute()
        {
            // Arrange.
            const string query = "time:\"2016-12\" += /04/13/38/22";
        ...
        [Fact, Trait("Category", TestAssembly.Category)]
        public void ScriptParser_Root_Add_Time_DDHHMMSS_FormattedString_DoubleQuotes_Relative()
        {
            // Arrange.
            const string query = "time:\"2016-12\" += 04/13/38/22";
        ...
        [Fact, Trait("Category", TestAssembly.Category)]
        public void ScriptParser_Root_Add_Time_SS_FormattedString_DoubleQuotes_Absolute()
        {
            // Arrange.
            const string query = "time:\"2016-12-04 13:38\" += /22";
        ...
        [Fact, Trait("Category", TestAssembly.Category)]
        public void ScriptParser_Root_Add_Time_SS_FormattedString_DoubleQuotes_Relative()
        {
            // Arrange.
            const string query = "time:\"2016-12-04 13:38\" += 22";
