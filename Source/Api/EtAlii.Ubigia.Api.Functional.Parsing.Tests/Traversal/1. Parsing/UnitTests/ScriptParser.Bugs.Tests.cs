...
[CorrelateUnitTests]
public class ScriptParserBugsTests : IClassFixture<FunctionalUnitTestContext>, IDisposable
{
    private IScriptParser _parser;

    public ScriptParserBugsTests(FunctionalUnitTestContext testContext)
    {
