...
namespace EtAlii.Ubigia.Api.Functional.Traversal.Tests
{
    ...
    public partial class ScriptParserTests
    {
        ...
        public void ScriptParser_Root_Add_Time_MMDDHHMMSS_String_SingleQuotes_Absolute()
        {
            // Arrange.
        ...
        [Fact, Trait("Category", TestAssembly.Category)]
        public void ScriptParser_Root_Add_Time_MMDDHHMMSS_String_SingleQuotes_Relative()
        {
            // Arrange.
            const string query = "time:'2016' += 12/04/13/38/22";
        ...
        [Fact, Trait("Category", TestAssembly.Category)]
        public void ScriptParser_Root_Add_Time_DDHHMMSS_String_SingleQuotes_Absolute()
        {
            // Arrange.
        ...
        [Fact, Trait("Category", TestAssembly.Category)]
        public void ScriptParser_Root_Add_Time_DDHHMMSS_String_SingleQuotes_Relative()
        {
            // Arrange.
            const string query = "time:'201612' += 04/13/38/22";
        ...
        [Fact, Trait("Category", TestAssembly.Category)]
        public void ScriptParser_Root_Add_Time_SS_String_SingleQuotes_Absolute()
        {
            // Arrange.
        ...
        [Fact, Trait("Category", TestAssembly.Category)]
        public void ScriptParser_Root_Add_Time_SS_String_SingleQuotes_Relative()
        {
            // Arrange.
            const string query = "time:'201612041338' += 22";
