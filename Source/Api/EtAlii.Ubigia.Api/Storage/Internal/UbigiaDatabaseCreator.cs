...
namespace EtAlii.Ubigia.Api.Storage.Internal
{
    ...
    ///     </para>
    /// </summary>
    public class UbigiaDatabaseCreator : IDatabaseCreator
    {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public UbigiaDatabaseCreator([NotNull] IDatabase database)
        {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        protected virtual IUbigiaDatabase Database => (IUbigiaDatabase)_database;
