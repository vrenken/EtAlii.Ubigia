...
namespace EtAlii.Ubigia.Api.Internal
{
    ...
    public static class InMemoryStrings
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("EtAlii.Ubigia.Api.Properties.InMemoryStrings", typeof(InMemoryStrings).GetTypeInfo().Assembly);
...
namespace EtAlii.Ubigia.Api.Internal
{
    ...
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("EtAlii.Ubigia.Api.Properties.InMemoryStrings", typeof(InMemoryResources).GetTypeInfo().Assembly);
