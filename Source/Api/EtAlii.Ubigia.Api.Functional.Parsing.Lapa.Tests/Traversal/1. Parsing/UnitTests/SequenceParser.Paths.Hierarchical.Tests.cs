...
namespace EtAlii.Ubigia.Api.Functional.Parsing.Tests
{
    ...
    [CorrelateUnitTests]
    public class SequenceParserPathsHierarchicalTests : IClassFixture<FunctionalUnitTestContext>, IAsyncLifetime
    {
        private ISequenceParser _parser;
        private readonly FunctionalUnitTestContext _testContext;

        public SequenceParserPathsHierarchicalTests(FunctionalUnitTestContext testContext)
        {
