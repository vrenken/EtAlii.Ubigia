...
namespace EtAlii.Ubigia.Api.Functional.Traversal.Tests
{
    ...
    public sealed class ScriptProcessorNonRootedPathAssignAnonymous2IntegrationTests : IClassFixture<FunctionalUnitTestContext>
    {
        private readonly IScriptParser _parser;
        private readonly FunctionalUnitTestContext _testContext;

        public ScriptProcessorNonRootedPathAssignAnonymous2IntegrationTests(FunctionalUnitTestContext testContext)
        {
