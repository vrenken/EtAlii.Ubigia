...
[CorrelateUnitTests]
public sealed class ScriptProcessorNonRootedPathAssignObjectIntegrationTests : IClassFixture<FunctionalUnitTestContext>
{
    private readonly IScriptParser _parser;
    private readonly FunctionalUnitTestContext _testContext;

    public ScriptProcessorNonRootedPathAssignObjectIntegrationTests(FunctionalUnitTestContext testContext)
    {
