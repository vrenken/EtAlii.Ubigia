...
[CorrelateUnitTests]
public sealed class ScriptProcessorRootedPathFunctionRenameTests : IClassFixture<FunctionalUnitTestContext>
{
    private readonly IScriptParser _parser;
    private readonly FunctionalUnitTestContext _testContext;

    public ScriptProcessorRootedPathFunctionRenameTests(FunctionalUnitTestContext testContext)
    {
