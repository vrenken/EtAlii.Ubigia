...
namespace EtAlii.Ubigia.Api.Functional.Traversal.Tests
{
    ...
    [CorrelateUnitTests]
    public sealed class ScriptProcessorRootedPathQueryWildcardIntegrationTests : IClassFixture<FunctionalUnitTestContext>
    {
        private readonly IScriptParser _parser;
        private readonly FunctionalUnitTestContext _testContext;

        public ScriptProcessorRootedPathQueryWildcardIntegrationTests(FunctionalUnitTestContext testContext)
        {
