...
namespace EtAlii.Ubigia.Api.Functional.Traversal.Tests
{
    ...
    public sealed class ScriptProcessorRootedPathFunctionCountTests : IClassFixture<FunctionalUnitTestContext>
    {
        private readonly IScriptParser _parser;
        private readonly FunctionalUnitTestContext _testContext;

        public ScriptProcessorRootedPathFunctionCountTests(FunctionalUnitTestContext testContext)
        {
