...
[CorrelateUnitTests]
public sealed class ScriptProcessorRootedPathAssignAnonymous2IntegrationTests : IClassFixture<FunctionalUnitTestContext>
{
    private readonly IScriptParser _parser;
    private readonly FunctionalUnitTestContext _testContext;

    public ScriptProcessorRootedPathAssignAnonymous2IntegrationTests(FunctionalUnitTestContext testContext)
    {
