...
namespace EtAlii.Ubigia.Api.Functional.Traversal.Tests
{
    ...
    public sealed class ScriptProcessorRootedPathTimeRegexCombinedDoubleQuotesTests : IClassFixture<FunctionalUnitTestContext>
    {
        ...
        [Fact]
        public async Task ScriptProcessor_RootedPath_Time_Select_YYYY_Regex_Combined_DoubleQuotes()
        {
            // Arrange.
        ...
        [Fact]
        public async Task ScriptProcessor_RootedPath_Time_Select_YYYYMM_Regex_Combined_DoubleQuotes()
        {
            // Arrange.
            var scope = new ExecutionScope();
            var logicalOptions = await _testContext.Logical
        ...
        [Fact]
        public async Task ScriptProcessor_RootedPath_Time_Select_YYYYMMDD_Regex_Combined_DoubleQuotes()
        {
            // Arrange.
            var scope = new ExecutionScope();
            var logicalOptions = await _testContext.Logical
        ...
        [Fact]
        public async Task ScriptProcessor_RootedPath_Time_Select_YYYYMMDDHH_Regex_Combined_DoubleQuotes()
        {
            // Arrange.
            var scope = new ExecutionScope();
            var logicalOptions = await _testContext.Logical
        ...
        [Fact]
        public async Task ScriptProcessor_RootedPath_Time_Select_YYYYMMDDHHMM_Regex_Combined_DoubleQuotes()
        {
            // Arrange.
            var scope = new ExecutionScope();
            var logicalOptions = await _testContext.Logical
            ...
            var addQuery = string.Join("\r\n", addQueries);
            var selectQuery1 = "/Time/2024/09/01/22/05/00/000";
            var selectQuery2 = "time:\"202409012205\"";
        ...
        [Fact]
        public async Task ScriptProcessor_RootedPath_Time_Select_YYYYMMDDHHMMSS_Regex_Combined_DoubleQuotes()
        {
            // Arrange.
            var scope = new ExecutionScope();
            var logicalOptions = await _testContext.Logical
        ...
        [Fact]
        public async Task ScriptProcessor_RootedPath_Time_Select_YYYYMMDDHHMMSSMMM_Regex_Combined_DoubleQuotes()
        {
            // Arrange.
            var scope = new ExecutionScope();
            var logicalOptions = await _testContext.Logical
