...
[CorrelateUnitTests]
public sealed class ScriptProcessorRootedPathAssignTagTests : IClassFixture<FunctionalUnitTestContext>
{
    private readonly IScriptParser _parser;
    private readonly FunctionalUnitTestContext _testContext;

    public ScriptProcessorRootedPathAssignTagTests(FunctionalUnitTestContext testContext)
    {
