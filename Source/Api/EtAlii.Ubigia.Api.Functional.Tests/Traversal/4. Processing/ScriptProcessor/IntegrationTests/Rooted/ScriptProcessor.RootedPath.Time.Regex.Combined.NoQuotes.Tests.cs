...
namespace EtAlii.Ubigia.Api.Functional.Traversal.Tests
{
    ...
    [CorrelateUnitTests]
    public sealed class ScriptProcessorRootedPathTimeRegexCombinedNoQuotesTests : IClassFixture<FunctionalUnitTestContext>
    {
        private readonly IScriptParser _parser;
        private readonly FunctionalUnitTestContext _testContext;

        public ScriptProcessorRootedPathTimeRegexCombinedNoQuotesTests(FunctionalUnitTestContext testContext)
        {
