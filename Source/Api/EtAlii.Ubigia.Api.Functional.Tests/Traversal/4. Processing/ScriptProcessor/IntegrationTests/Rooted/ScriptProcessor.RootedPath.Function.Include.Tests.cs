...
namespace EtAlii.Ubigia.Api.Functional.Traversal.Tests
{
    ...
    public sealed class ScriptProcessorRootedPathFunctionIncludeTests : IClassFixture<FunctionalUnitTestContext>
    {
        private readonly IScriptParser _parser;
        private readonly FunctionalUnitTestContext _testContext;

        public ScriptProcessorRootedPathFunctionIncludeTests(FunctionalUnitTestContext testContext)
        {
