...
[CorrelateUnitTests]
public sealed class ScriptProcessorRootedPathTimeRegexSeparatedDoubleQuotesTests : IClassFixture<FunctionalUnitTestContext>
{
    private readonly IScriptParser _parser;
    private readonly FunctionalUnitTestContext _testContext;

    public ScriptProcessorRootedPathTimeRegexSeparatedDoubleQuotesTests(FunctionalUnitTestContext testContext)
    {
