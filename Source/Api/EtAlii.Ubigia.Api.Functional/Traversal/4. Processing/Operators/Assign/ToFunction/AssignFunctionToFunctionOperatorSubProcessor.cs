namespace EtAlii.Ubigia.Api.Functional.Traversal
{
    ...
    internal class AssignFunctionToFunctionOperatorSubProcessor : IAssignFunctionToFunctionOperatorSubProcessor
    {
        ...
        public AssignFunctionToFunctionOperatorSubProcessor(
