...
internal class TimeRootByRegexBasedSeparatedYyyymmddhhHandler : IRootHandler
{
    ...
    public TimeRootByRegexBasedSeparatedYyyymmddhhHandler(ITimePreparer timePreparer)
    {
        _timePreparer = timePreparer;

        Template = new PathSubjectPart[] { new RegexPathSubjectPart(@"\d{4}-\d{2}-\d{2}[\sT]\d{2}") };
    }
