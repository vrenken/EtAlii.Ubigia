        ...
        protected void TestInitialization(IHash a_hash)
        {
            ...
            if (a_hash is IFastHash32)
            {
                ...
                List<Action> fast_list = new List<Action>()
                {
                    ...
                    () => fast_hash.ComputeCharsFast(new[] { 'c', 'c' }), 
                    () => fast_hash.ComputeDoubleFast(3.456489566e156), 
                    () => fast_hash.ComputeDoublesFast(new[] { 3.456489566e156, 3.456489566e156 }), 
                    () => fast_hash.ComputeFloatFast(3.45698986e16f), 
                    () => fast_hash.ComputeFloatsFast(new[] { 3.45698986e16f, 3.45698986e16f }), 
                    () => fast_hash.ComputeIntFast(1234567456), 
                    () => fast_hash.ComputeIntsFast(new[] { 1234567456, 1234567456 }), 
                    () => fast_hash.ComputeLongFast(7632345678765765765), 
                    () => fast_hash.ComputeLongsFast(new[] { 7632345678765765765, 7632345678765765765 }), 
                    ...
                    () => fast_hash.ComputeUIntsFast(new[] { 3234567456, 3234567456 }), 
                    () => fast_hash.ComputeULongFast(9632345678765765765), 
                    () => fast_hash.ComputeULongsFast(new[] { 9632345678765765765, 9632345678765765765 }), 
