...
namespace Samples.Commands
{
        ...
        where T : class, ICommand, new()
    {
        ...
        /// </summary>
        /// <typeparam name="TObject">The type of the queried item.</typeparam>
        /// <param name="child">A direct or indirect child of the
        /// queried item.</param>
        /// <returns>The first parent item that matches the submitted
        /// type parameter. If not matching item can be found, a null
        /// reference is being returned.</returns>
        public static TObject TryFindParent<TObject>(DependencyObject child)
            where TObject : DependencyObject
        {
            ...
            TObject parent = parentObject as TObject;
            if (parent != null)
            {
                return parent;
            }
            else
            {
                ...
                return TryFindParent<TObject>(parentObject);
            }
        }
