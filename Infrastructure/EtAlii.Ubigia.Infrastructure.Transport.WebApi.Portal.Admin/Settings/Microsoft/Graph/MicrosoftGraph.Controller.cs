...
namespace EtAlii.Ubigia.Infrastructure.Transport.WebApi.Portal.Admin
{
    ...
    [RoutePrefix(RelativeUri.Admin.MicrosoftGraphSettings), CacheWebApi(-1)]
    public class MicrosoftGraphAdminController : AdminControllerBase
    {
        ...
        public MicrosoftGraphAdminController(
