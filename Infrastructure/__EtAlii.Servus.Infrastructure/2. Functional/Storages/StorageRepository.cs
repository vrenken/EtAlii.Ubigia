namespace EtAlii.Servus.Infrastructure.Functional
{
    ...
    internal class StorageRepository :  IStorageRepository
    {
            ...
            IStorageInitializer storageInitializer)
        {
            ...
            _logicalContext.Storages.LocalStorageInitialized += OnLocalStorageInitialized;
            _logicalContext.Storages.StorageInitialized += OnStorageInitialized;
        }
        ...
        private void OnStorageInitialized(object sender, Api.Storage storage)
        {
