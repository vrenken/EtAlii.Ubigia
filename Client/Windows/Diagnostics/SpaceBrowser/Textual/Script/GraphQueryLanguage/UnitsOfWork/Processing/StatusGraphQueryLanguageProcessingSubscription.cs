namespace EtAlii.Ubigia.Windows.Diagnostics.SpaceBrowser
{
    ...
    public class StatusGraphQueryLanguageProcessingSubscription : IStatusGraphQueryLanguageProcessingSubscription
    {
        ...
        public void Subscribe(IObservable<QueryExecutionResult> results, IGraphQueryLanguageViewModel viewModel,
            ...
            results.LastOrDefaultAsync()
                ...
                onNext: o =>
                {
                    ...
                    if (errors.Count == 0)
                    {
                        ...
                        Task.Delay(200).Wait();
                        _statusWriter.Write(viewModel, "Query execution finished successfull.");
