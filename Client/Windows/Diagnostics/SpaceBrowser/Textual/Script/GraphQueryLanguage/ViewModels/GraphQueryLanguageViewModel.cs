...
//            _scope = new QueryScope();
            ...
            _queryChangedSubscription = Observable.FromEvent((handler) => CodeChanged += handler, (handler) => CodeChanged -= handler)
            ...
            Code = _graphContext.QueryProcessor.Process(new TextTemplateQuery("EtAlii.Ubigia.Windows.Diagnostics.SpaceBrowser.Textual.Script.GraphQueryLanguage.Templates.SimpleQuery.gql"), textTemplateQueryHandler).Single();
        }
