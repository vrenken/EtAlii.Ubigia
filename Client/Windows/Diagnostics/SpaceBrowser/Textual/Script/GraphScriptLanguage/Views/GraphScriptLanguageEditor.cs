namespace EtAlii.Ubigia.Windows.Diagnostics.SpaceBrowser
{
    ...
    public sealed class GraphScriptLanguageEditor : TextEditor
    {
        ...
        public static readonly DependencyProperty CodeProperty = DependencyProperty.Register("Code", typeof(string), typeof(GraphScriptLanguageEditor), new PropertyMetadata(String.Empty));
