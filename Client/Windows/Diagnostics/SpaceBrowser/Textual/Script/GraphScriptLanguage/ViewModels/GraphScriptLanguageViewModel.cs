namespace EtAlii.Ubigia.Windows.Diagnostics.SpaceBrowser
{
    ...
    public class GraphScriptLanguageViewModel : TextualViewModelBase, IGraphScriptLanguageViewModel
    {
            ...
            IProcessGraphScriptLanguageUnitOfworkHandler processScriptUnitOfworkHandler)
        {
            ...
            Code = _graphContext.QueryProcessor.Process(new TextTemplateQuery("EtAlii.Ubigia.Windows.Diagnostics.SpaceBrowser.Textual.Script.GraphScriptLanguage.Templates.SimpleScript.gsl"), textTemplateQueryHandler).Single();
        }
