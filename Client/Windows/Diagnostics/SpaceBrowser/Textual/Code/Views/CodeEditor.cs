namespace EtAlii.Ubigia.Windows.Diagnostics.SpaceBrowser.Views
{
    ...
    public sealed class CodeEditor : TextEditor
    {
        ...
        public static readonly DependencyProperty CodeProperty = DependencyProperty.Register("Code", typeof(string), typeof(CodeEditor), new PropertyMetadata(String.Empty));
