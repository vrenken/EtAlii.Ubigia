namespace EtAlii.Servus.Client.Windows.Diagnostics
{
    ...
    public class MainWindowFactory
    {
        public MainWindow Create(IProfilingDataConnection connection, IDiagnosticsConfiguration diagnostics)
        {
            ...
            container.Register<NewDocumentCommand>(Lifestyle.Transient);
            ...
            return CreateWindow(container);
        }

        private MainWindow CreateWindow(Container container)
        {
