namespace EtAlii.Servus.Storage.Portable
{
    ...
    public class PortablePathBuilder : IPathBuilder
    {
        ...
        public PortablePathBuilder(IStorageConfiguration configuration, IStorageSerializer serializer)
        {
            ...
            //_baseFolder = PortablePath.Combine(FileSystem.Current.LocalStorage.Path, "EtAlii", "Servus", configuration.Name);
            _baseFolder = PortablePath.Combine("EtAlii", "Servus", configuration.Name);
            //_baseFolder = "E";//PortablePath.Combine("EtAlii", "Servus", configuration.Name);
        }
