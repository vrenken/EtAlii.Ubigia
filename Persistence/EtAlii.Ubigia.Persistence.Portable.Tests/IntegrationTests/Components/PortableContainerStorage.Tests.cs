namespace EtAlii.Ubigia.Persistence.Portable.Tests
{
    ...
    public class PortableComponentStorageTests : PortableStorageTestBase
    {
        ...
        [Fact, Trait("Category", TestAssembly.Category)]
        public void PortableComponentStorage_Store_Retrieve_Entry()
        {
            // Arrange.
            var storageId = Guid.NewGuid();
            var accountId = Guid.NewGuid();
        ...
        [Fact, Trait("Category", TestAssembly.Category)]
        public void PortableComponentStorage_Store_Retrieve_ChildrenComponent()
        {
            // Arrange.
            var storageId = Guid.NewGuid();
            var accountId = Guid.NewGuid();
        ...
        */
        ...
        [Fact, Trait("Category", TestAssembly.Category)]
        public void PortableComponentStorage_Store_Retrieve_ParentComponent()
        {
            // Arrange.
            var storageId = Guid.NewGuid();
            var accountId = Guid.NewGuid();
        ...
        [Fact, Trait("Category", TestAssembly.Category)]
        public void PortableComponentStorage_Store_Retrieve_NextComponent()
        {
            // Arrange.
            var storageId = Guid.NewGuid();
            var accountId = Guid.NewGuid();
        ...
        [Fact, Trait("Category", TestAssembly.Category)]
        public void PortableComponentStorage_Store_Retrieve_PreviousComponent()
        {
            // Arrange.
            var storageId = Guid.NewGuid();
            var accountId = Guid.NewGuid();
        ...
        [Fact, Trait("Category", TestAssembly.Category)]
        public void PortableComponentStorage_Store_Retrieve_UpdateComponent()
        {
            // Arrange.
            var storageId = Guid.NewGuid();
            var accountId = Guid.NewGuid();
        ...
        [Fact, Trait("Category", TestAssembly.Category)]
        public void PortableComponentStorage_Store_Retrieve_DowndateComponent()
        {
            // Arrange.
            var storageId = Guid.NewGuid();
            var accountId = Guid.NewGuid();
        ...
        [Fact, Trait("Category", TestAssembly.Category)]
        public void PortableComponentStorage_Store_Retrieve_TypeComponent()
        {
            // Arrange.
        ...
        [Fact, Trait("Category", TestAssembly.Category)]
        public void PortableComponentStorage_Store_Retrieve_TagComponent()
        {
            // Arrange.
