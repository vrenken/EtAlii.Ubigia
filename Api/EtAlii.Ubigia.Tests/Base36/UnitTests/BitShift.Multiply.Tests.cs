namespace EtAlii.Ubigia.Tests.UnitTests
{
    ...
    public class BitShift_AndTests
    {
        ...
        {
            // Arrange.
            var bits = "10110".Select(c => c == '1').ToArray(); // 22
        ...
        {
            // Arrange.
            var bits = "000".Select(c => c == '1').ToArray(); // 0
        ...
        {
            // Arrange.
            var bits = "010".Select(c => c == '1').ToArray(); // 2
            var multiplication = "010".Select(c => c == '1').ToArray(); // 2
        ...
        {
            // Arrange.
            var bits = "0010".Select(c => c == '1').ToArray(); // 2
            var multiplication = "010".Select(c => c == '1').ToArray(); // 2
        ...
        {
            // Arrange.
            var bits = "111".Select(c => c == '1').ToArray(); // 7
            var multiplication = "001".Select(c => c == '1').ToArray(); // 1
