namespace EtAlii.Ubigia.Api.Transport.Management.WebApi
{
    ...
    internal sealed class WebApiSpaceDataClient : WebApiClientBase, ISpaceDataClient
    {
        ...
        {
            var address = Connection.AddressFactory.Create(Connection.Transport, RelativeUri.Data.Spaces, UriParameter.SpaceTemplate, template.Name);
        ...
        {
            var address = Connection.AddressFactory.Create(Connection.Transport, RelativeUri.Data.Spaces, UriParameter.SpaceId, spaceId.ToString());
...
//              AccountId = accountId,
        ...
        {
            var address = Connection.AddressFactory.Create(Connection.Transport, RelativeUri.Data.Spaces, UriParameter.AccountId, accountId.ToString(), UriParameter.SpaceName, spaceName);
