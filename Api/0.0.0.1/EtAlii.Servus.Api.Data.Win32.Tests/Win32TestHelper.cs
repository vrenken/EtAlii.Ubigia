namespace EtAlii.Servus.Api.Helpers.Win32.Tests
{
    ...
    public static class Win32TestHelper
    {
        ...
        public static void SaveResourceTestImage(string fileName)
        {
            ...
            using (Stream stream = assembly.GetManifestResourceStream("EtAlii.Servus.Api.Functional.Win32.Tests.TestImage_01.jpg"))
            {
