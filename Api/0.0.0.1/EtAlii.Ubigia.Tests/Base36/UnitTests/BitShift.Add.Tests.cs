namespace EtAlii.Ubigia.Tests.UnitTests
{
    ...
    public class BitShift_AddTests
    {
        ...
        {
            // Arrange.
            var bits = "001".Select(c => c == '1').ToArray(); // 1
        ...
        {
            // Arrange.
            var bits = "0001".Select(c => c == '1').ToArray(); // 1
            var addition = "001".Select(c => c == '1').ToArray(); // 1
        ...
        {
            // Arrange.
            var bits = "011".Select(c => c == '1').ToArray(); // 3
        ...
        {
            // Arrange.
            var bits = "1100010101".Select(c => c == '1').ToArray(); // 789
        ...
        {
            // Arrange.
            var bits = "1001001001".Select(c => c == '1').ToArray(); // 585
        ...
        {
            // Arrange.
            var bits = "111001000".Select(c => c == '1').ToArray(); // 456
        ...
        {
            // Arrange.
            var bits = "1111111111111111".Select(c => c == '1').ToArray(); // 65535
        ...
        {
            // Arrange.
            var bits = "111111111111".Select(c => c == '1').ToArray(); // 4095
