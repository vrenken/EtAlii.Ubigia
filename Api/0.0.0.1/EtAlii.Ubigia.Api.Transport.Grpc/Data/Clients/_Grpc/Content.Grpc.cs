...
namespace EtAlii.Ubigia.Api.Transport.Grpc.WireProtocol {
  ...
  public static partial class ContentGrpcService
  {
    ...
    {
      serviceBinder.AddMethod(__Method_Get, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::EtAlii.Ubigia.Api.Transport.Grpc.WireProtocol.ContentGetRequest, global::EtAlii.Ubigia.Api.Transport.Grpc.WireProtocol.ContentGetResponse>(serviceImpl.Get));
      serviceBinder.AddMethod(__Method_GetPart, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::EtAlii.Ubigia.Api.Transport.Grpc.WireProtocol.ContentPartGetRequest, global::EtAlii.Ubigia.Api.Transport.Grpc.WireProtocol.ContentPartGetResponse>(serviceImpl.GetPart));
      serviceBinder.AddMethod(__Method_Post, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::EtAlii.Ubigia.Api.Transport.Grpc.WireProtocol.ContentPostRequest, global::EtAlii.Ubigia.Api.Transport.Grpc.WireProtocol.ContentPostResponse>(serviceImpl.Post));
      serviceBinder.AddMethod(__Method_PostPart, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::EtAlii.Ubigia.Api.Transport.Grpc.WireProtocol.ContentPartPostRequest, global::EtAlii.Ubigia.Api.Transport.Grpc.WireProtocol.ContentPartPostResponse>(serviceImpl.PostPart));
    }
