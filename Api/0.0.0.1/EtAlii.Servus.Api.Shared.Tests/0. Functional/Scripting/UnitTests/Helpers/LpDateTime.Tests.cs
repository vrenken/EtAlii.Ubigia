namespace EtAlii.Servus.Api.Functional.Tests
{
    ...
    public partial class LpDateTime_Tests
    {
        ...
        public void LpDateTime_Parse_TimeSpan_00()
        {
            ...
            Assert.AreEqual(new TimeSpan(0, 23, 1, 0), result);
        }
        ...
        public void LpDateTime_Parse_TimeSpan_03()
        {
            ...
            // Assert.
            Assert.IsTrue(success);
            Assert.AreEqual(new TimeSpan(2, 23, 01, 20, 123), result);
        }
        ...
        public void LpDateTime_Parse_DateTime_01()
        {
            ...
            // Assert.
            Assert.IsTrue(success);
            Assert.AreEqual(new DateTime(2015, 07, 28, 11, 09, 0), result);
        }
        ...
        public void LpDateTime_Parse_DateTime_02()
        {
            ...
            // Assert.
            Assert.IsTrue(success);
            Assert.AreEqual(new DateTime(2015, 07, 28, 11, 09, 28), result);
        }
        ...
        public void LpDateTime_Parse_DateTime_03()
        {
            ...
            // Assert.
            Assert.IsTrue(success);
            Assert.AreEqual(new DateTime(2015, 07, 28, 11, 09, 28, 123), result);
        }
