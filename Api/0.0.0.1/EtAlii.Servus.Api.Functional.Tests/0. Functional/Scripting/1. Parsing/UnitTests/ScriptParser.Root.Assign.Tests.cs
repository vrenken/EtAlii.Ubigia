...
namespace EtAlii.Servus.Api.Functional.Tests
{
    ...
    public partial class ScriptParser_Tests
    {
        ...
        {
            // Arrange.
            const string query = "root:time <= EtAlii.Servus.Roots.Time";
            ...
            Assert.Equal("EtAlii.Servus.Roots.Time", sequence.Parts.Skip(2).Cast<RootDefinitionSubject>().First().Type);
        }
        ...
        {
            // Arrange.
            const string query = "root:specialtime <= EtAlii.Servus.Roots.Time";
        ...
        {
            // Arrange.
            const string query = "root:projects <= EtAlii.Servus.Roots.Object";
            ...
            Assert.IsType<AssignOperator>(sequence.Parts.ElementAt(1));
            Assert.Equal("EtAlii.Servus.Roots.Object", sequence.Parts.Skip(2).Cast<RootDefinitionSubject>().First().Type);
        }
        ...
        {
            // Arrange.
            const string query = "root:projects <= EtAlii.Servus.Roots.Object";//":/[Words]/[Number]";
