namespace EtAlii.Ubigia.Api.Transport.SignalR
{
    ...
    internal class SignalREntryDataClient : SignalRClientBase, IEntryDataClient<ISignalRSpaceTransport> 
    {
        ...
        public override async Task Connect(ISpaceConnection<ISignalRSpaceTransport> spaceConnection)
        {
			...
			_connection = new HubConnectionFactory().Create(spaceConnection.Transport, new Uri(spaceConnection.Storage.Address + SignalRHub.BasePath + UriConstant.PathSeparator + SignalRHub.Entry, UriKind.Absolute));//spaceConnection.Transport.HttpClientHandler);
