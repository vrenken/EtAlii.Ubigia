namespace EtAlii.Ubigia.Api.Transport.SignalR
{
    ...
    internal class SignalRRootDataClient : SignalRClientBase, IRootDataClient<ISignalRSpaceTransport>
    {
        ...
        public override async Task Connect(ISpaceConnection<ISignalRSpaceTransport> spaceConnection)
        {
            ...
            _connection = new HubConnectionFactory().Create(spaceConnection.Transport, new Uri(spaceConnection.Storage.Address + SignalRHub.BasePath + UriConstant.PathSeparator + SignalRHub.Root, UriKind.Absolute));
