namespace EtAlii.Ubigia.Api.Transport.SignalR
{
    ...
    public partial class SignalRAuthenticationDataClient : SignalRClientBase, IAuthenticationDataClient<ISignalRSpaceTransport>
    {
        ...
        public override async Task Connect(ISpaceConnection<ISignalRSpaceTransport> spaceConnection)
        {
			...
			_accountConnection = factory.Create(spaceConnection.Transport, new Uri(spaceConnection.Storage.Address + SignalRHub.BasePath + UriConstant.PathSeparator + SignalRHub.Account, UriKind.Absolute));
			_spaceConnection = factory.Create(spaceConnection.Transport, new Uri(spaceConnection.Storage.Address + SignalRHub.BasePath + UriConstant.PathSeparator + SignalRHub.Space, UriKind.Absolute));
