namespace EtAlii.Servus.Api
{
    ...
    public class InfrastructureClient : IInfrastructureClient
    {
        ...
        public InfrastructureClient(IPayloadSerializer payloadSerializer)
        {
        ...
        public TResult Get<TResult>(string address, ICredentials credentials = null)
        {
            ...
            using (var client = CreateHttpClient(credentials))
            {
                ...
                //catch (InvalidInfrastructureOperationException e)
                //{
                //    throw new InfrastructureConnectionException(_getErrorMessage, e);
                //}
                //catch (UnauthorizedInfrastructureOperationException e)
                //{
                //    throw new InfrastructureConnectionException(_getErrorMessage, e);
                //}
            }
