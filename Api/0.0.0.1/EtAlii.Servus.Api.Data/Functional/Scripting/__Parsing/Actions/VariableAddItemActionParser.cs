namespace EtAlii.Servus.Api.Data
{
    ...
    internal class VariableAddItemActionParser : IActionParser
    {
        ...
        public VariableAddItemActionParser(
            ...
            PathExpressions pathExpressions)
        {
            ...
            _actionId = NonTerminalId.VariableAddAction;

            // $[VAR] = /[PATH]/ += [PATH] #[COMMENT]
            _expressionParser = (terminalExpressions.Variable + operatorExpressions.Assign + pathExpressions.Rooted + terminalExpressions.Separator + operatorExpressions.Add + pathExpressions.NonRooted).Id(NonTerminalId.VariableAddAction);
        }
        ...
        public Action Parse(LpNode node)
        {
            ...
            var itemToAdd = _pathParser.Parse(node, 5);
            var result = new VariableAddItem(path, itemToAdd, variableName);
            return result;
        }
    }
}
