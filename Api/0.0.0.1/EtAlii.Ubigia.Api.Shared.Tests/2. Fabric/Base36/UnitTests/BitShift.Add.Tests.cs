namespace EtAlii.Ubigia.Api.Fabric.Tests
{
    ...
    public class BitShift_Add_Tests
    {
        ...
        public void BitShift_Add_001_And_001_Is_010()
        {
            ...
            var addition = "001".Select(c => c == '1' ? true : false).ToArray(); // 1
        ...
        {
            // Arrange.
            var bits = "0001".Select(c => c == '1' ? true : false).ToArray(); // 1
            var addition = "001".Select(c => c == '1' ? true : false).ToArray(); // 1
        ...
        public void BitShift_Add_001_And_0001_Is_0010()
        {
            // Arrange.
            var bits = "001".Select(c => c == '1' ? true : false).ToArray(); // 1
            var addition = "0001".Select(c => c == '1' ? true : false).ToArray(); // 1
        ...
        {
            // Arrange.
            var bits = "011".Select(c => c == '1' ? true : false).ToArray(); // 3
            var shift = "001".Select(c => c == '1' ? true : false).ToArray(); // 1
        ...
        public void BitShift_Add_1100010101_And_101101_Is_1101000010()
        {
            ...
            var addition = "101101".Select(c => c == '1' ? true : false).ToArray(); // 45
        ...
        public void BitShift_Add_1100010101_And_111001000_Is_10011011101()
        {
            // Arrange.
            var bits = "1100010101".Select(c => c == '1' ? true : false).ToArray(); // 789
            var addition = "111001000".Select(c => c == '1' ? true : false).ToArray(); // 456
        ...
        {
            // Arrange.
            var bits = "1001001001".Select(c => c == '1' ? true : false).ToArray(); // 585
            var addition = "101010101".Select(c => c == '1' ? true : false).ToArray(); // 341
        ...
        {
            // Arrange.
            var bits = "111001000".Select(c => c == '1' ? true : false).ToArray(); // 456
            var addition = "1100010101".Select(c => c == '1' ? true : false).ToArray(); // 789
        ...
        {
            // Arrange.
            var bits = "1111111111111111".Select(c => c == '1' ? true : false).ToArray(); // 65535
            var addition = "111111111111".Select(c => c == '1' ? true : false).ToArray(); // 4095
        ...
        {
            // Arrange.
            var bits = "111111111111".Select(c => c == '1' ? true : false).ToArray(); // 4095
            var addition = "1111111111111111".Select(c => c == '1' ? true : false).ToArray(); // 65535
