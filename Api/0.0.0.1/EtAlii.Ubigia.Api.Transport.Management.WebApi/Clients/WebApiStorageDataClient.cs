namespace EtAlii.Ubigia.Api.Transport.Management.WebApi
{
    ...
    internal sealed partial class WebApiStorageDataClient : WebApiClientBase, IStorageDataClient
    {
        ...
        {
            var addAddress = Connection.AddressFactory.Create(Connection.Storage, RelativeUri.ApiRest + RelativeUri.Data.Storages);
        ...
        {
            var address = Connection.AddressFactory.Create(Connection.Storage, RelativeUri.ApiRest + RelativeUri.Data.Storages, UriParameter.StorageId, storageId.ToString());
        ...
        {
            var address = Connection.AddressFactory.Create(Connection.Storage, RelativeUri.ApiRest + RelativeUri.Data.Storages, UriParameter.StorageName, storageName);
        ...
        {
            var address = Connection.AddressFactory.Create(Connection.Storage, RelativeUri.ApiRest + RelativeUri.Data.Storages);
