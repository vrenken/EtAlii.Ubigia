namespace EtAlii.Ubigia.Api.Transport.Management.WebApi
{
    ...
    internal class WebApiAccountDataClient : WebApiClientBase, IAccountDataClient
    {
        ...
        {
            var address = Connection.AddressFactory.Create(Connection.Storage, RelativeUri.Data.Accounts, UriParameter.AccountId, accountId.ToString());
        ...
        public async Task<Account> Change(Guid accountId, string accountName, string accountPassword)
        {
            ...
            var changeAddress = Connection.AddressFactory.Create(Connection.Storage, RelativeUri.Data.Accounts, UriParameter.AccountId, accountId.ToString());
        ...
        {
            var changeAddress = Connection.AddressFactory.Create(Connection.Storage, RelativeUri.Data.Accounts, UriParameter.AccountId, account.Id.ToString());
            account = await Connection.Client.Put(changeAddress, account);
            return account;
        }
        ...
        {
            var address = Connection.AddressFactory.Create(Connection.Storage, RelativeUri.Data.Accounts, UriParameter.AccountName, accountName);
        ...
        {
            var address = Connection.AddressFactory.Create(Connection.Storage, RelativeUri.Data.Accounts);
