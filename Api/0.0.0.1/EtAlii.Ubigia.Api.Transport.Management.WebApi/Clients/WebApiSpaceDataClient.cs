namespace EtAlii.Ubigia.Api.Transport.Management.WebApi
{
    ...
    internal sealed class WebApiSpaceDataClient : WebApiClientBase, ISpaceDataClient
    {
        ...
        {
            var address = Connection.AddressFactory.Create(Connection.Storage, RelativeUri.Data.Spaces, UriParameter.SpaceId, spaceId.ToString());
...
//              AccountId = accountId,
        ...
        {
            var address = Connection.AddressFactory.Create(Connection.Storage, RelativeUri.Data.Spaces, UriParameter.AccountId, accountId.ToString(), UriParameter.SpaceName, spaceName);
        ...
        {
            var address = Connection.AddressFactory.Create(Connection.Storage, RelativeUri.Data.Spaces, UriParameter.AccountId, accountId.ToString());
