namespace EtAlii.Ubigia.Api.Transport.Tests
{
        ...
        where THostTestContext: class, IHostTestContext, new()
    {
        ...
        public Task<IDataConnection> CreateDataConnectionToNewSpace(bool openOnCreation = true)
        {
	        ...
	        return CreateDataConnectionToNewSpace(Context.DataApiAddress, accountName, password, openOnCreation);
		}
        ...
        {
			return CreateDataConnectionToNewSpace(Context.DataApiAddress, accountName, accountPassword, openOnCreation, spaceTemplate);
        }
        ...
        {
            return CreateDataConnectionToExistingSpace(Context.DataApiAddress, accountName, accountPassword, spaceName, openOnCreation);
        }
        ...
        {
			return CreateManagementConnection(Context.ManagementApiAddress, Context.TestAccountName, Context.TestAccountPassword, openOnCreation);
        }
