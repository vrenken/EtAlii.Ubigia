namespace EtAlii.Ubigia.Api.Functional.Tests
{
    ...
    public class ScriptProcessorAssignDynamicLocationsIntegrationTests : IClassFixture<LogicalUnitTestContext>, IDisposable
    {
        ...
        public async Task ScriptProcessor_Assign_Dynamic_To_Path()
        {
            ...
            var updateQuery = "<= /Locations/Europe/NL/Overijssel/Enschede/Helmerhoek <= $data";
