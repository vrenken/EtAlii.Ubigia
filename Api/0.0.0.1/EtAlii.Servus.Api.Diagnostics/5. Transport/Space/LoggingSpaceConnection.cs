namespace EtAlii.Servus.Api.Transport
{
    ...
    public class LoggingSpaceConnection : ISpaceConnection
    {
        ...
        public async Task Open()
        {
            ...
            message = String.Format("Opened space connection (Address: {0} Duration: {1}ms)", _address, Environment.TickCount - start);
            _logger.Info(message);
        }
        ...
        public async Task Close()
        {
            ...
            message = String.Format("Closed space connection (Address: {0} Duration: {1}ms)", _address, Environment.TickCount - start);
            _logger.Info(message);
        }
