namespace EtAlii.Servus.Api.Management
{
    ...
    public class LoggingStorageConnection : IStorageConnection
    {
        ...
        public async Task Open()
        {
            ...
            message = String.Format("Opened storage connection (Address: {0} Duration: {1}ms)", _address, Environment.TickCount - start);
            _logger.Info(message);
        }
        ...
        public async Task Close()
        {
            ...
            message = String.Format("Closed storage connection (Address: {0} Duration: {1}ms)", _address, Environment.TickCount - start);
            _logger.Info(message);
        }
