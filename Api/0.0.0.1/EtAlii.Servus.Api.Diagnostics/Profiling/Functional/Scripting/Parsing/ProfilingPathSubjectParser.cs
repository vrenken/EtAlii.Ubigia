namespace EtAlii.Servus.Api.Diagnostics.Profiling
{
    ...
    internal class ProfilingPathSubjectParser : IPathSubjectParser
    {
        private readonly IPathSubjectParser _decoree;
        private readonly IProfiler _profiler;

        public ProfilingPathSubjectParser(
            IPathSubjectParser decoree,
            IProfiler profiler)
        {
            _decoree = decoree;
