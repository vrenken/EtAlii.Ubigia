...
//    internal class ToIdentifierAssignerSelector : Selector2<GraphPath, object, IToIdentifierAssigner>, IToIdentifierAssignerSelector
//    {
...
//        {
//            Register((path, o) => path.Last() is GraphTaggedNode && o is string, constantToIdentifierTagAssigner)
//                .Register((path, o) => o is IInternalNode, nodeToIdentifierAssigner)
//                .Register((path, o) => o is IPropertyDictionary, propertiesToIdentifierAssigner)
//                .Register(IsDynamicObject, dynamicObjectToIdentifierAssigner);
//        }

//        public new IToIdentifierAssigner TrySelect(GraphPath path, object o)
//        {
//            return base.TrySelect(path, o);
//        }
