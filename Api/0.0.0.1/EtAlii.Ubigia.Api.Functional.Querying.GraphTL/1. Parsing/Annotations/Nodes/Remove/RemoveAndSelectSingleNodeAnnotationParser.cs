namespace EtAlii.Ubigia.Api.Functional
{
    ...
    internal class RemoveAndSelectSingleNodeAnnotationParser : IRemoveAndSelectSingleNodeAnnotationParser
    {
        ...
        public RemoveAndSelectSingleNodeAnnotationParser(INodeValidator nodeValidator, INodeFinder nodeFinder)
        {
            _nodeValidator = nodeValidator;
            _nodeFinder = nodeFinder;
            var content = new LpsParser(ContentId, true, Lp.LetterOrDigit().OneOrMore()); 

            Parser = new LpsParser(Id, true, "@" + AnnotationPrefix.NodeRemove + "(" + content.Maybe() + ")");
        }
        ...
        public AnnotationNew Parse(LpNode node)
        {
            ...
            return new RemoveAndSelectSingleNodeAnnotation(null, null);
        }
