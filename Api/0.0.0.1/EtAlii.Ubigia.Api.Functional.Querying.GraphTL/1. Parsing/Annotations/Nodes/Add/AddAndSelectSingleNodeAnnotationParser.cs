namespace EtAlii.Ubigia.Api.Functional
{
    ...
    internal class AddAndSelectSingleNodeAnnotationParser : IAddAndSelectSingleNodeAnnotationParser
    {
        ...
        public AddAndSelectSingleNodeAnnotationParser(INodeValidator nodeValidator, INodeFinder nodeFinder)
        {
            ...
            Parser = new LpsParser(Id, true, "@" + AnnotationPrefix.NodeAdd + "(" + content.Maybe() + ")");
        }
        ...
        public AnnotationNew Parse(LpNode node)
        {
            ...
            return new AddAndSelectSingleNodeAnnotation(null, null);
        }
