namespace EtAlii.Servus.Api.Functional
{
    ...
    public class TypedPathFormatter
    {
        ...
        public static class Text
        {
            ...
            private static readonly Lazy<TypedPathFormatter> _wordFormatter = new Lazy<TypedPathFormatter>(() => new TypedPathFormatter("WORD", @"^\w+$"));
        ...
        public static class Name
        {
            ...
            private static readonly Lazy<TypedPathFormatter> _firstNameFormatter = new Lazy<TypedPathFormatter>(() => new TypedPathFormatter("FIRSTNAME", @"^\w+$"));
            public static TypedPathFormatter LastNameFormatter => _lastNameFormatter.Value;
            private static readonly Lazy<TypedPathFormatter> _lastNameFormatter = new Lazy<TypedPathFormatter>(() => new TypedPathFormatter("LASTNAME", @"^\w+$"));
        }
