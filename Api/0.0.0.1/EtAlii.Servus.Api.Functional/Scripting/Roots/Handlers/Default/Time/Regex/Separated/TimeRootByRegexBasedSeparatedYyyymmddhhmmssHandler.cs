namespace EtAlii.Servus.Api.Functional
{
    ...
    public class TimeRootByRegexBasedSeparatedYyyymmddhhmmssHandler : IRootHandler
    {

        public PathSubjectPart[] Template { get { return _template; } }
        private readonly PathSubjectPart[] _template;

        public TimeRootByRegexBasedSeparatedYyyymmddhhmmssHandler()
        {
        ...
        public void Process(IRootContext context, PathSubjectPart[] match, PathSubjectPart[] rest, ExecutionScope scope, IObserver<object> output)
        {
            ...
            var minute = Int32.Parse(time.Substring(14, 2));
            var second = Int32.Parse(time.Substring(17, 2));
