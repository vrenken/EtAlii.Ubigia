namespace EtAlii.Ubigia.Api.Transport.Management.Tests
{
    ...
    public class ManagementConnectionTests : IClassFixture<StartedTransportUnitTestContext>, IDisposable
    {
        ...
        public async Task ManagementConnection_Open()
        {
            ...
            var connection = await _testContext.TransportTestContext.CreateManagementConnection(context.ManagementApiAddress, context.TestAccountName, context.TestAccountPassword, false);
        ...
        public async Task ManagementConnection_Open_Invalid_Password()
        {
			// Arrange.
			var context = _testContext.TransportTestContext.Context;
            var connection = await _testContext.TransportTestContext.CreateManagementConnection(context.ManagementApiAddress, context.TestAccountName, context.TestAccountPassword + "BAAD", false);
        ...
        public async Task ManagementConnection_Open_Invalid_Account()
        {
			// Arrange.
			var context = _testContext.TransportTestContext.Context;
            var connection = await _testContext.TransportTestContext.CreateManagementConnection(context.ManagementApiAddress, context.TestAccountName + "BAAD", context.TestAccountPassword, false);
        ...
        public async Task ManagementConnection_Open_Invalid_Account_And_Password()
        {
			// Arrange.
			var context = _testContext.TransportTestContext.Context;
            var connection = await _testContext.TransportTestContext.CreateManagementConnection(context.ManagementApiAddress, context.TestAccountName + "BAAD", context.TestAccountPassword + "BAAD", false);
