namespace EtAlii.Servus.Api.Management.WebApi
{
    ...
    internal sealed class WebApiSpaceDataClient : WebApiClientBase, ISpaceDataClient
    {
        ...
        {
            var address = Connection.AddressFactory.Create(Connection.Storage, RelativeUri.Spaces, UriParameter.SpaceTemplate, template.Name);
        ...
        {
            var address = Connection.AddressFactory.Create(Connection.Storage, RelativeUri.Spaces, UriParameter.SpaceId, spaceId.ToString());
...
//              AccountId = accountId,
        ...
        {
            var address = Connection.AddressFactory.Create(Connection.Storage, RelativeUri.Spaces, UriParameter.AccountId, accountId.ToString(), UriParameter.SpaceName, spaceName);
        ...
        {
            var address = Connection.AddressFactory.Create(Connection.Storage, RelativeUri.Spaces, UriParameter.AccountId, accountId.ToString());
