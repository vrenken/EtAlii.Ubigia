namespace EtAlii.Ubigia.Api.Fabric
{
    ...
    public class FabricContextConfiguration : Configuration<IFabricContextExtension, FabricContextConfiguration>, IFabricContextConfiguration, IEditableFabricContextConfiguration 
    {
