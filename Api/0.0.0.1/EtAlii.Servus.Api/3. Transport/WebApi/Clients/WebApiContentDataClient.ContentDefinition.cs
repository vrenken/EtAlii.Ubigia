namespace EtAlii.Servus.Api.Transport.WebApi
{
    ...
    internal partial class WebApiContentDataClient
    {
        ...
        {
            var address = Connection.AddressFactory.Create(Connection.Storage, RelativeUri.ContentDefinition, UriParameter.EntryId, identifier.ToString());
        ...
        {
            var address = Connection.AddressFactory.Create(Connection.Storage, RelativeUri.ContentDefinition, UriParameter.EntryId, identifier.ToString(), UriParameter.ContentDefinitionPartId, contentDefinitionPart.Id.ToString());
